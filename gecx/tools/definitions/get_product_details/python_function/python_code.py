...
def get_product_details(product_id: str) -> dict[str, Any]:
    ...
    mock_details = {
        ...
        "P027": {"id": "P027", "name": "NorthLake Forge SoftStrike Forged Iron Set", "price": "$1,299.99", "features": ["Compact hollow-body forged construction", "Tour flight in scoring irons", "Minimal offset through the set", "Steel and graphite shaft options", "Custom fit recommended"], "reviews": "4.46/5 stars from 432 reviews", "availability": "In Stock", "image_url": club_image, "imageUris": [club_image], "imageAlt": "Real golf irons in a bag on a golf course."},
        "P024": {"id": "P024", "name": "NorthLake Forge TourPocket Pro Iron Set", "price": "$1,199.99", "features": ["One-piece forged carbon steel", "Tour flight launch profile", "Moderate offset for practical forgiveness", "6-PW, GW, SW set makeup"], "reviews": "4.02/5 stars from 415 reviews", "availability": "Limited stock", "image_url": club_image, "imageUris": [club_image], "imageAlt": "Real golf irons in a bag on a golf course."},
